...
export default function UserProfilePage(props) {
  return (
    <div>
      <div className="page-content page-container" id="userProfileBody">
                    ...
                    <div className="row m-l-0 m-r-0">
                        <div className="col-sm-4 bg-c-lite-green user-profile">
                            <div className="card-block text-center text-white">
                                ...
                                <a href='edit.js'>Edit Profile</a> <i className=" mdi mdi-square-edit-outline feather icon-edit m-t-10 f-16"></i>
                            </div>
                        </div>
